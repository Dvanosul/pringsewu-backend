...
public class CountryRepository : BaseRepository<Country, Context>, ICountryRepository
{
    public CountryRepository(IUnitOfWork<Context> unitOfWork) : base(unitOfWork) { }
}
