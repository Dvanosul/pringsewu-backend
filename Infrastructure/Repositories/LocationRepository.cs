...
public class LocationRepository : BaseRepository<Location, Context>, ILocationRepository
{
    public LocationRepository(IUnitOfWork<Context> unitOfWork) : base(unitOfWork) { }
}
