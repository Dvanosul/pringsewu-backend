...
public class SubDistrictRepository : BaseRepository<SubDistrict, Context>, ISubDistrictRepository
{
    public SubDistrictRepository(IUnitOfWork<Context> unitOfWork) : base(unitOfWork) { }
}
