...
public class DistrictRepository : BaseRepository<District, Context>, IDistrictRepository
{
    public DistrictRepository(IUnitOfWork<Context> unitOfWork) : base(unitOfWork) { }
}
