...
{
    public class LanguageRepository : BaseRepository<Language, Context>, ILanguageRepository
    {
        public LanguageRepository(IUnitOfWork<Context> unitOfWork) : base(unitOfWork) { }
    }
}
